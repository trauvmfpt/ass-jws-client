(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simditor', ["jquery","simple-module","simple-hotkeys","simple-uploader","web/admin/resources/simditor-2.3.23/site/assets/scripts/dompurify"], function ($, SimpleModule, simpleHotkeys, simpleUploader, DOMPurify) {
    ...
    // like Node.
    module.exports = factory(require("jquery"),require("simple-module"),require("simple-hotkeys"),require("simple-uploader"),require("web/admin/resources/simditor-2.3.23/site/assets/scripts/dompurify"));
  } else {
