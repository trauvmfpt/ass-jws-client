...
public class User  implements java.io.Serializable {
    ...
    private t1708e.asm.diduduadi.service.comment.Post[] postSet;

    private t1708e.asm.diduduadi.service.comment.Rating[] ratingSet;

    private t1708e.asm.diduduadi.service.comment.Role[] roleSet;
    ...
    public User(
           ...
           t1708e.asm.diduduadi.service.comment.Post[] postSet,
           t1708e.asm.diduduadi.service.comment.Rating[] ratingSet,
           t1708e.asm.diduduadi.service.comment.Role[] roleSet,
     ...
     * @return postSet
     */
    public t1708e.asm.diduduadi.service.comment.Post[] getPostSet() {
        return postSet;
    }
     ...
     * @param postSet
     */
    public void setPostSet(t1708e.asm.diduduadi.service.comment.Post[] postSet) {
        this.postSet = postSet;
    }

    public t1708e.asm.diduduadi.service.comment.Post getPostSet(int i) {
        return this.postSet[i];
    }

    public void setPostSet(int i, t1708e.asm.diduduadi.service.comment.Post _value) {
     ...
     * @return roleSet
     */
    public t1708e.asm.diduduadi.service.comment.Role[] getRoleSet() {
        return roleSet;
    }
     ...
     * @param roleSet
     */
    public void setRoleSet(t1708e.asm.diduduadi.service.comment.Role[] roleSet) {
        this.roleSet = roleSet;
    }

    public t1708e.asm.diduduadi.service.comment.Role getRoleSet(int i) {
        return this.roleSet[i];
    }

    public void setRoleSet(int i, t1708e.asm.diduduadi.service.comment.Role _value) {
