...
public class Rating  implements java.io.Serializable {
    ...
    private t1708e.asm.diduduadi.service.image.Image image;

    private t1708e.asm.diduduadi.service.image.Post post;
    ...
    public Rating(
           int id,
           t1708e.asm.diduduadi.service.image.Image image,
           t1708e.asm.diduduadi.service.image.Post post,
           double star,
     ...
     * @return image
     */
    public t1708e.asm.diduduadi.service.image.Image getImage() {
        return image;
    }
     ...
     * @param image
     */
    public void setImage(t1708e.asm.diduduadi.service.image.Image image) {
        this.image = image;
    }
     ...
     * @return post
     */
    public t1708e.asm.diduduadi.service.image.Post getPost() {
        return post;
    }
     ...
     * @param post
     */
    public void setPost(t1708e.asm.diduduadi.service.image.Post post) {
        this.post = post;
    }
