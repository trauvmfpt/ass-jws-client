...
public class Post  implements java.io.Serializable {
    private t1708e.asm.diduduadi.service.search.Comment[] commentSet;

    private int id;

    private t1708e.asm.diduduadi.service.search.Image[] imageSet;

    private java.lang.String info;

    private t1708e.asm.diduduadi.service.search.Place place;

    private t1708e.asm.diduduadi.service.search.Rating[] ratingSet;

    private int status;

    private t1708e.asm.diduduadi.service.search.User user;

    public Post() {
    }

    public Post(
           t1708e.asm.diduduadi.service.search.Comment[] commentSet,
           int id,
           t1708e.asm.diduduadi.service.search.Image[] imageSet,
           java.lang.String info,
           t1708e.asm.diduduadi.service.search.Place place,
           t1708e.asm.diduduadi.service.search.Rating[] ratingSet,
           int status,
           t1708e.asm.diduduadi.service.search.User user) {
     ...
     * @return commentSet
     */
    public t1708e.asm.diduduadi.service.search.Comment[] getCommentSet() {
        return commentSet;
    }
     ...
     * @param commentSet
     */
    public void setCommentSet(t1708e.asm.diduduadi.service.search.Comment[] commentSet) {
        this.commentSet = commentSet;
    }

    public t1708e.asm.diduduadi.service.search.Comment getCommentSet(int i) {
        return this.commentSet[i];
    }

    public void setCommentSet(int i, t1708e.asm.diduduadi.service.search.Comment _value) {
     ...
     * @return imageSet
     */
    public t1708e.asm.diduduadi.service.search.Image[] getImageSet() {
        return imageSet;
    }
     ...
     * @param imageSet
     */
    public void setImageSet(t1708e.asm.diduduadi.service.search.Image[] imageSet) {
        this.imageSet = imageSet;
    }

    public t1708e.asm.diduduadi.service.search.Image getImageSet(int i) {
        return this.imageSet[i];
    }

    public void setImageSet(int i, t1708e.asm.diduduadi.service.search.Image _value) {
     ...
     * @return place
     */
    public t1708e.asm.diduduadi.service.search.Place getPlace() {
        return place;
    }
     ...
     * @param place
     */
    public void setPlace(t1708e.asm.diduduadi.service.search.Place place) {
        this.place = place;
    }
     ...
     * @return ratingSet
     */
    public t1708e.asm.diduduadi.service.search.Rating[] getRatingSet() {
        return ratingSet;
    }
     ...
     * @param ratingSet
     */
    public void setRatingSet(t1708e.asm.diduduadi.service.search.Rating[] ratingSet) {
        this.ratingSet = ratingSet;
    }

    public t1708e.asm.diduduadi.service.search.Rating getRatingSet(int i) {
        return this.ratingSet[i];
    }

    public void setRatingSet(int i, t1708e.asm.diduduadi.service.search.Rating _value) {
     ...
     * @return user
     */
    public t1708e.asm.diduduadi.service.search.User getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(t1708e.asm.diduduadi.service.search.User user) {
        this.user = user;
    }
