...
public class User  implements java.io.Serializable {
    ...
    private t1708e.asm.diduduadi.service.post.Post[] postSet;

    private t1708e.asm.diduduadi.service.post.Rating[] ratingSet;

    private t1708e.asm.diduduadi.service.post.Role[] roleSet;
    ...
    public User(
           ...
           t1708e.asm.diduduadi.service.post.Post[] postSet,
           t1708e.asm.diduduadi.service.post.Rating[] ratingSet,
           t1708e.asm.diduduadi.service.post.Role[] roleSet,
     ...
     * @return postSet
     */
    public t1708e.asm.diduduadi.service.post.Post[] getPostSet() {
        return postSet;
    }
     ...
     * @param postSet
     */
    public void setPostSet(t1708e.asm.diduduadi.service.post.Post[] postSet) {
        this.postSet = postSet;
    }

    public t1708e.asm.diduduadi.service.post.Post getPostSet(int i) {
        return this.postSet[i];
    }

    public void setPostSet(int i, t1708e.asm.diduduadi.service.post.Post _value) {
     ...
     * @return roleSet
     */
    public t1708e.asm.diduduadi.service.post.Role[] getRoleSet() {
        return roleSet;
    }
     ...
     * @param roleSet
     */
    public void setRoleSet(t1708e.asm.diduduadi.service.post.Role[] roleSet) {
        this.roleSet = roleSet;
    }

    public t1708e.asm.diduduadi.service.post.Role getRoleSet(int i) {
        return this.roleSet[i];
    }

    public void setRoleSet(int i, t1708e.asm.diduduadi.service.post.Role _value) {
