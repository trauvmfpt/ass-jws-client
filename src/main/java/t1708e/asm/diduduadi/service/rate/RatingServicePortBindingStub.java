/**
 * RatingServicePortBindingStub.java
 *
...
public class RatingServicePortBindingStub extends org.apache.axis.client.Stub implements t1708e.asm.diduduadi.service.rate.RatingService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("update");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "arg0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://service/", "rating"), t1708e.asm.diduduadi.service.rate.Rating.class, false, false);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("delete");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "arg0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://service/", "user"), t1708e.asm.diduduadi.service.rate.User.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        oper.setReturnClass(boolean.class);
        ...
        oper.setReturnClass(t1708e.asm.diduduadi.service.rate.Rating[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "return"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[3] = oper;
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getByUserIdAndPostId");
    ...
    public RatingServicePortBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public RatingServicePortBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public RatingServicePortBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            cls = t1708e.asm.diduduadi.service.rate.Comment.class;
            ...
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.rate.Image.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.rate.Place.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.rate.Post.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.rate.Rating.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.rate.Role.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.rate.User.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (t1708e.asm.diduduadi.service.rate.Rating[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (t1708e.asm.diduduadi.service.rate.Rating[]) org.apache.axis.utils.JavaUtils.convert(_resp, t1708e.asm.diduduadi.service.rate.Rating[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
    ...
    public t1708e.asm.diduduadi.service.rate.Rating getByUserIdAndPostId(int arg0, int arg1) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://service/", "getByUserIdAndPostId"));
