...
public class PlaceServiceServiceLocator extends org.apache.axis.client.Service implements t1708e.asm.diduduadi.service.place.PlaceServiceService {
    ...
    public t1708e.asm.diduduadi.service.place.PlaceService getPlaceServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public t1708e.asm.diduduadi.service.place.PlaceService getPlaceServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            t1708e.asm.diduduadi.service.place.PlaceServicePortBindingStub _stub = new t1708e.asm.diduduadi.service.place.PlaceServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (t1708e.asm.diduduadi.service.place.PlaceService.class.isAssignableFrom(serviceEndpointInterface)) {
                t1708e.asm.diduduadi.service.place.PlaceServicePortBindingStub _stub = new t1708e.asm.diduduadi.service.place.PlaceServicePortBindingStub(new java.net.URL(PlaceServicePort_address), this);
                _stub.setPortName(getPlaceServicePortWSDDServiceName());
                return _stub;
            }
        }
