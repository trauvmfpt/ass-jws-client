...
public class Post  implements java.io.Serializable {
    ...
    private t1708e.asm.diduduadi.service.test.Image[] imageSet;

    private java.lang.String info;

    private t1708e.asm.diduduadi.service.test.Place place;

    private t1708e.asm.diduduadi.service.test.Rating[] ratingSet;

    private int status;

    private t1708e.asm.diduduadi.service.test.User user;
    ...
    public Post(
           ...
           int id,
           t1708e.asm.diduduadi.service.test.Image[] imageSet,
           java.lang.String info,
           t1708e.asm.diduduadi.service.test.Place place,
           t1708e.asm.diduduadi.service.test.Rating[] ratingSet,
           int status,
           t1708e.asm.diduduadi.service.test.User user) {
     ...
     * @return imageSet
     */
    public t1708e.asm.diduduadi.service.test.Image[] getImageSet() {
        return imageSet;
    }
     ...
     * @param imageSet
     */
    public void setImageSet(t1708e.asm.diduduadi.service.test.Image[] imageSet) {
        this.imageSet = imageSet;
    }

    public t1708e.asm.diduduadi.service.test.Image getImageSet(int i) {
        return this.imageSet[i];
    }

    public void setImageSet(int i, t1708e.asm.diduduadi.service.test.Image _value) {
     ...
     * @return place
     */
    public t1708e.asm.diduduadi.service.test.Place getPlace() {
        return place;
    }
     ...
     * @param place
     */
    public void setPlace(t1708e.asm.diduduadi.service.test.Place place) {
        this.place = place;
    }
     ...
     * @return user
     */
    public t1708e.asm.diduduadi.service.test.User getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(t1708e.asm.diduduadi.service.test.User user) {
        this.user = user;
    }
