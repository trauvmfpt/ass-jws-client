...
public class Role  implements java.io.Serializable {
    ...
    private t1708e.asm.diduduadi.service.test.User[] userSet;
    ...
    public Role(
           ...
           t1708e.asm.diduduadi.service.test.User[] userSet) {
           this.id = id;
           this.name = name;
     ...
     * @return userSet
     */
    public t1708e.asm.diduduadi.service.test.User[] getUserSet() {
        return userSet;
    }
     ...
     * @param userSet
     */
    public void setUserSet(t1708e.asm.diduduadi.service.test.User[] userSet) {
        this.userSet = userSet;
    }

    public t1708e.asm.diduduadi.service.test.User getUserSet(int i) {
        return this.userSet[i];
    }

    public void setUserSet(int i, t1708e.asm.diduduadi.service.test.User _value) {
