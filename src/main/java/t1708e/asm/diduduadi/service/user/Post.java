...
public class Post  implements java.io.Serializable {
    ...
    private t1708e.asm.diduduadi.service.user.Image[] imageSet;

    private java.lang.String info;

    private t1708e.asm.diduduadi.service.user.Place place;
    ...
    public Post(
           ...
           int id,
           t1708e.asm.diduduadi.service.user.Image[] imageSet,
           java.lang.String info,
           t1708e.asm.diduduadi.service.user.Place place,
     ...
     * @return imageSet
     */
    public t1708e.asm.diduduadi.service.user.Image[] getImageSet() {
        return imageSet;
    }
     ...
     * @param imageSet
     */
    public void setImageSet(t1708e.asm.diduduadi.service.user.Image[] imageSet) {
        this.imageSet = imageSet;
    }

    public t1708e.asm.diduduadi.service.user.Image getImageSet(int i) {
        return this.imageSet[i];
    }

    public void setImageSet(int i, t1708e.asm.diduduadi.service.user.Image _value) {
     ...
     * @return place
     */
    public t1708e.asm.diduduadi.service.user.Place getPlace() {
        return place;
    }
     ...
     * @param place
     */
    public void setPlace(t1708e.asm.diduduadi.service.user.Place place) {
        this.place = place;
    }
