...
public class User  implements java.io.Serializable {
    ...
    private t1708e.asm.diduduadi.service.user.Comment[] commentSet;
    ...
    private t1708e.asm.diduduadi.service.user.Post[] postSet;

    private t1708e.asm.diduduadi.service.user.Rating[] ratingSet;

    private t1708e.asm.diduduadi.service.user.Role[] roleSet;
    ...
    public User(
           ...
           int age,
           t1708e.asm.diduduadi.service.user.Comment[] commentSet,
           java.lang.String email,
           int gender,
           int id,
           java.lang.String name,
           java.lang.String password,
           t1708e.asm.diduduadi.service.user.Post[] postSet,
           t1708e.asm.diduduadi.service.user.Rating[] ratingSet,
           t1708e.asm.diduduadi.service.user.Role[] roleSet,
     ...
     * @return commentSet
     */
    public t1708e.asm.diduduadi.service.user.Comment[] getCommentSet() {
        return commentSet;
    }
     ...
     * @param commentSet
     */
    public void setCommentSet(t1708e.asm.diduduadi.service.user.Comment[] commentSet) {
        this.commentSet = commentSet;
    }

    public t1708e.asm.diduduadi.service.user.Comment getCommentSet(int i) {
        return this.commentSet[i];
    }

    public void setCommentSet(int i, t1708e.asm.diduduadi.service.user.Comment _value) {
     ...
     * @return postSet
     */
    public t1708e.asm.diduduadi.service.user.Post[] getPostSet() {
        return postSet;
    }
     ...
     * @param postSet
     */
    public void setPostSet(t1708e.asm.diduduadi.service.user.Post[] postSet) {
        this.postSet = postSet;
    }

    public t1708e.asm.diduduadi.service.user.Post getPostSet(int i) {
        return this.postSet[i];
    }

    public void setPostSet(int i, t1708e.asm.diduduadi.service.user.Post _value) {
     ...
     * @return ratingSet
     */
    public t1708e.asm.diduduadi.service.user.Rating[] getRatingSet() {
        return ratingSet;
    }
     ...
     * @param ratingSet
     */
    public void setRatingSet(t1708e.asm.diduduadi.service.user.Rating[] ratingSet) {
        this.ratingSet = ratingSet;
    }

    public t1708e.asm.diduduadi.service.user.Rating getRatingSet(int i) {
        return this.ratingSet[i];
    }

    public void setRatingSet(int i, t1708e.asm.diduduadi.service.user.Rating _value) {
     ...
     * @return roleSet
     */
    public t1708e.asm.diduduadi.service.user.Role[] getRoleSet() {
        return roleSet;
    }
     ...
     * @param roleSet
     */
    public void setRoleSet(t1708e.asm.diduduadi.service.user.Role[] roleSet) {
        this.roleSet = roleSet;
    }

    public t1708e.asm.diduduadi.service.user.Role getRoleSet(int i) {
        return this.roleSet[i];
    }

    public void setRoleSet(int i, t1708e.asm.diduduadi.service.user.Role _value) {
