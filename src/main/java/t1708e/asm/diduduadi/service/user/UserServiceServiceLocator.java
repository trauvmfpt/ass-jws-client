...
public class UserServiceServiceLocator extends org.apache.axis.client.Service implements t1708e.asm.diduduadi.service.user.UserServiceService {
    ...
    public t1708e.asm.diduduadi.service.user.UserService getUserServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public t1708e.asm.diduduadi.service.user.UserService getUserServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            t1708e.asm.diduduadi.service.user.UserServicePortBindingStub _stub = new t1708e.asm.diduduadi.service.user.UserServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (t1708e.asm.diduduadi.service.user.UserService.class.isAssignableFrom(serviceEndpointInterface)) {
                t1708e.asm.diduduadi.service.user.UserServicePortBindingStub _stub = new t1708e.asm.diduduadi.service.user.UserServicePortBindingStub(new java.net.URL(UserServicePort_address), this);
                _stub.setPortName(getUserServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service/", "UserServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service/", "UserServicePort"));
        }
