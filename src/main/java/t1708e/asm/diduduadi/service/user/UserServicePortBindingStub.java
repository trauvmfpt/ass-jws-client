/**
 * UserServicePortBindingStub.java
 *
...
public class UserServicePortBindingStub extends org.apache.axis.client.Stub implements t1708e.asm.diduduadi.service.user.UserService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(t1708e.asm.diduduadi.service.user.User.class);
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "arg0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://service/", "user"), t1708e.asm.diduduadi.service.user.User.class, false, false);
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://service/", "InvalidKeySpecException"),
                      "t1708e.asm.diduduadi.service.user.InvalidKeySpecException",
                      new javax.xml.namespace.QName("http://service/", "InvalidKeySpecException"), 
                      true
                     ));
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://service/", "NoSuchAlgorithmException"),
                      "t1708e.asm.diduduadi.service.user.NoSuchAlgorithmException",
                      new javax.xml.namespace.QName("http://service/", "NoSuchAlgorithmException"), 
                      true
                     ));
        _operations[4] = oper;
    ...
    public UserServicePortBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public UserServicePortBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public UserServicePortBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.1");
            ...
            cls = t1708e.asm.diduduadi.service.user.Comment.class;
            ...
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.user.Image.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://service/", "InvalidKeySpecException");
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.user.InvalidKeySpecException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://service/", "NoSuchAlgorithmException");
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.user.NoSuchAlgorithmException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.user.Place.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.user.Post.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.user.Rating.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.user.Role.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = t1708e.asm.diduduadi.service.user.User.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public t1708e.asm.diduduadi.service.user.User detail(int arg0) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://service/", "detail"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(arg0)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (t1708e.asm.diduduadi.service.user.User) _resp;
            } catch (java.lang.Exception _exception) {
                return (t1708e.asm.diduduadi.service.user.User) org.apache.axis.utils.JavaUtils.convert(_resp, t1708e.asm.diduduadi.service.user.User.class);
            }
        }
